#ifndef UBCORE_EVENTGENERATOR_HNLGEN_FLUXREADERBNB_H
#define UBCORE_EVENTGENERATOR_HNLGEN_FLUXREADERBNB_H
...
namespace hnlgen {
  class FluxReaderBNB : public FluxReader {
    ...
    private: 
      ...
      double K2nu_branching_ratio(const int id);
...
#endif // UBCORE_EVENTGENERATOR_HNLGEN_FLUXREADERBNB_H

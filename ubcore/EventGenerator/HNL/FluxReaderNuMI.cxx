...
hnlgen::FluxReaderNuMI::FluxReaderNuMI(fhicl::ParameterSet const& p, CLHEP::HepRandomEngine& fRNG)
...
hnlgen::FluxReaderNuMI::~FluxReaderNuMI() {
  if(dk2nu) delete dk2nu;
}

bool hnlgen::FluxReaderNuMI::get_kaon_from_flux(TLorentzVector& kmom, TLorentzVector& kpos, int& kpdg, int& pi_type, double& weight) {
...
double hnlgen::FluxReaderNuMI::K2nu_branching_ratio(const int ndecay) {
  /* ndecay:
   *
   1  KL0 → νe  + π− + e+
   2  KL0 → ν ̄e + π+ + e−
  ...
  switch(ndecay) {
    ...
    case 3:
    case 4:
      return 0.2020+0.2020+0.1348+0.1348; 
      break;
    case 5:
    case 6:
    case 7:
...
void hnlgen::FluxReaderNuMI::get_MCFlux(simb::MCFlux& flux) {
  get_current_entry();
  flux.Reset();

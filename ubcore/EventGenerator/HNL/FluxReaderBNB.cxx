...
hnlgen::FluxReaderBNB::FluxReaderBNB(fhicl::ParameterSet const& p, CLHEP::HepRandomEngine& fRNG)
...
hnlgen::FluxReaderBNB::~FluxReaderBNB() {
}

bool hnlgen::FluxReaderBNB::get_kaon_from_flux(TLorentzVector& kmom, TLorentzVector& kpos, int& kpdg, int& pi_type, double& weight) {
  ...
  weight = fBranch.beamwgt  / K2nu_branching_ratio(fBranch.id[1]);
...
double hnlgen::FluxReaderBNB::K2nu_branching_ratio(const int id) {
  /* ndecay:
   *
   1  KL0 → νe  + π− + e+
   2  KL0 → ν ̄e + π+ + e−
  ...
  switch(id) {
    case 10:
      return 0.20275+0.20275+0.1352+0.1352;
      break;
    case 11:
    case 12:
      return 0.6356+0.03352+0.0507;
      break;
    case 5:
    case 6:
      return 1.;
...
void hnlgen::FluxReaderBNB::get_MCFlux(simb::MCFlux& flux) {
  get_current_entry();
  flux.Reset();
